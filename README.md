...
- 파이썬 응용
    ...
    ![PyQt예제](https://raw.githubusercontent.com/guswlrla/basic-python-2024/main/images/python_004.png)
...
- 파이썬 실행파일 만들기
    ...
    - pip installer pyinstaller 패키지 설치
    - pyinstaller -w -F 파이썬.py (-w: 콘솔 창 없애기, -F: 실행파일 하나로 만들기)